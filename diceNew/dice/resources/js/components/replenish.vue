        ...
        <div class="payment_method">
            ...
            <div class="payment_method_bank" @click="changeBank">
                <label class="freecassa active">
                    <input type="radio" name="bank" value="spb" checked>
                </label>
                <label class="spb">
                    <input type="radio" name="bank" value="freekassa">
                </label>
                <label class="visa">
                    <input type="radio" name="bank" value="spb">
                </label>
                <label class="U_money">
                    <input type="radio" name="bank" value="spb">
                </label>
    ...
    export default {
        ...
        methods: {
            changeBank(e) {
                ...
                this.changeActiveBank(target);
            },

            changeActiveBank(target) {
                let labels = document.querySelectorAll('.payment_method_bank label');
                for (let label of labels) {
                    label.classList.remove('active');
                }
                target.classList.add('active');
                target.children.bank.checked = true;
                this.bank = target.children.bank.value;
            },
